...
func (uc *UserController) Index(c *fiber.Ctx) error {
	...
	result := config.DB.Select("id, name, email, created_at, updated_at").Find(&users)
	if result.Error != nil {
...
func (uc *UserController) Show(c *fiber.Ctx) error {
	...
	result := config.DB.Select("id, name, email, created_at, updated_at").First(&user, id)
	if result.Error != nil {
...
func (uc *UserController) Update(c *fiber.Ctx) error {
	...
	config.DB.Select("id, name, email, created_at, updated_at").First(&user, id)
